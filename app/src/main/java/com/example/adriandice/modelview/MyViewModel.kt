package com.example.SimonDicePCClase.modelview
...
import com.example.SimonDicePCClase.model.Colores
import com.example.SimonDicePCClase.model.ColoresIluminados
import com.example.SimonDicePCClase.model.Datos
import com.example.SimonDicePCClase.model.Estados
import kotlin.random.Random
import com.example.SimonDicePCClase.model.Datos.record
import com.example.SimonDicePCClase.model.Datos.rondas
import com.example.SimonDicePCClase.model.Datos.aciertos
import com.example.SimonDicePCClase.model.Datos.numRandom
...
class MyViewModel(private val context: Context): ViewModel() {
    ...
    fun setRandom(){
        ...
        Log.d("EstadoApp", "El estado ha cambiado a "+estadoLiveData.value)
    ...
    fun onWin(listaColores: MutableList<Int>) {
        ...
        // Aquí es donde mostramos el Toast cuando el jugador gana
        Toast.makeText(context, "¡Ganaste! Start para continuar!!!", Toast.LENGTH_SHORT).show()
    }
    ...
    fun onLose(listaColores: MutableList<Int>) {
        ...
        // Aquí es donde mostramos el Toast cuando el jugador pierde
